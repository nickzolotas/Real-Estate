...
declare const NavbarDropdown: import("../internals/types").InternalRefForwardingComponent<"div", NavbarDropdownProps<any>, never> & {
    ...
    Menu: React.ForwardRefExoticComponent<import("../Nav/NavDropdownMenu").NavDropdownMenuProps<any> & import("../internals/types").SanitizedHTMListProps & React.RefAttributes<HTMLElement>>;
};
