...
const Cascader = (0, _utils3.forwardRef)((props, ref) => {
  ...
  const flattenedData = (0, _react.useMemo)(() => (0, _utils.flattenTree)(data, item => childrenMap.get(item) ?? item[childrenKey]), [childrenMap, childrenKey, data]);
  ...
  const handleMenuPressEnter = (0, _hooks2.useEventCallback)(event => {
    ...
    if (isLeafNode) {
      ...
      if (!(0, _utils3.shallowEqual)(value, focusItemValue)) {
        onSelect?.(focusItem, pathTowardsActiveItem, event);
