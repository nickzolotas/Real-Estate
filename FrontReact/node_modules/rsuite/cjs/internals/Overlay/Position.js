...
const usePosition = (props, ref) => {
  ...
  (placementChanged = true, forceUpdateDOM) => {
    ...
    const containerElement = (0, _getContainer.default)(typeof container === 'function' ? container() : container ?? null, (0, _ownerDocument.default)(ref.current).body);
  ...
  (0, _react.useEffect)(() => {
    ...
    if (containerRef.current && preventOverflow) {
      ...
      containerScrollListener = (0, _on.default)(containerRef.current?.tagName === 'BODY' ? window : containerRef.current, 'scroll', () => updatePosition(true, true));
    }
